...
(() => {
  ...
  const stylesheet =
    ...
    // Print engines drop or mis-place an absolutely-positioned,
    // transform-centered <img>. At print, put the frame and image back in
    // normal flow so the picture lands on the sheet.
    '.frame{position:relative !important;overflow:hidden !important}' +
    'img{position:static !important;transform:none !important;' +
    'width:100% !important;height:100% !important;max-width:100% !important;' +
    'object-fit:contain !important;display:block !important;visibility:visible !important}' +
    '}' +
  ...
  class ImageSlot extends HTMLElement {
    ...
    constructor() {
      ...
      root.innerHTML =
        ...
        '<div class="ctl" popover="manual" data-dc-edit-transparent><button data-act="replace" title="Cambiar imagen">Cambiar</button>' +
        '  <button data-act="edit" title="Reencuadrar imagen">Encuadrar</button></div>' +
    ...
    async _ingest(file) {
      ...
      if (!file || ACCEPT.indexOf(file.type) < 0) {
        this._setError('Usá una imagen PNG, JPEG, WebP o AVIF.');
        return;
      }
