...
-- CreateEnum
CREATE TYPE "LeadType" AS ENUM ('PRESUPUESTO', 'VISITA', 'URGENCIA', 'CONSULTA');

-- CreateEnum
CREATE TYPE "LeadStatus" AS ENUM ('NEW', 'CONTACTED', 'QUOTED', 'ACCEPTED', 'IN_PROGRESS', 'COMPLETED', 'LOST');
...
-- CreateIndex
CREATE INDEX "Lead_serviceSlug_idx" ON "Lead"("serviceSlug");
