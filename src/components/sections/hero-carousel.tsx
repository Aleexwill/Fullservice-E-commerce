...
const FALLBACK_SLIDES: Slide[] = [
  { id: '1', label: 'Soldadura y estructuras', tag: 'Metalúrgica', description: 'Fabricación de rejas, portones, estructuras metálicas y trabajos de soldadura en general.', photoUrl: '', accent: '#2D8FCC', gradient: 'from-[#0a1628] via-[#1a3a5c] to-[#0d2340]', overlayOpacity: 55, order: 0 },
  { id: '2', label: 'Obra civil y remodelación', tag: 'Construcción', description: 'Construcción, ampliación y remodelación de locales comerciales e industriales.', photoUrl: '', accent: '#E8862B', gradient: 'from-[#1a1200] via-[#2d2000] to-[#1a1200]', overlayOpacity: 55, order: 1 },
  { id: '3', label: 'Mantenimiento general', tag: 'Preventivo y correctivo', description: 'Mantenimiento integral de instalaciones, equipos y espacios industriales.', photoUrl: '', accent: '#48BB78', gradient: 'from-[#0a1a0f] via-[#0f2d1a] to-[#0a1a0f]', overlayOpacity: 55, order: 2 },
  ...
  { id: '5', label: 'Electricidad y plomería', tag: 'Instalaciones', description: 'Instalaciones eléctricas, sanitarias y de gas para todo tipo de obras.', photoUrl: '', accent: '#F6E05E', gradient: 'from-[#1a1200] via-[#2d2000] to-[#0a1628]', overlayOpacity: 55, order: 4 },
];
