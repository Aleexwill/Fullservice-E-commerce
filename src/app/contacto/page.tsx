...
const subjectsGeneral = ['Información de la empresa', 'Reclamo o sugerencia', 'Otro'];
const subjectsEcommerce = ['Consulta sobre producto', 'Estado de mi pedido', 'Devolución o cambio', 'Disponibilidad de producto'];
const subjectsServicios = ['Presupuesto de mantenimiento', 'Presupuesto de obra civil', 'Presupuesto de trabajos metalúrgicos', 'Consulta sobre servicios'];
