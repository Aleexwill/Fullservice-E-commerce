    ...
    <>
      <div className="border-b border-steel-900/40">
        <div className="container-main flex items-center gap-2 py-3 font-body text-caption text-steel-500">
          ...
          <span className="text-arctic">Términos y condiciones</span>
        </div>
      </div>
      ...
      <section className="section-sm border-b border-steel-900/40 bg-gradient-hero">
        <div className="container-main">
          ...
          <h1 className="font-display text-h1 uppercase text-arctic">Términos y Condiciones</h1>
      ...
      <section className="section">
        <div className="container-main max-w-3xl space-y-8 font-body text-body text-steel-300">
          <div>
            <h2 className="mb-2 font-display text-h3 text-arctic">1. Aceptación de los términos</h2>
            <p>
          ...
          <div>
            <h2 className="mb-2 font-display text-h3 text-arctic">2. Sobre nosotros</h2>
            <p>
          ...
          <div>
            <h2 className="mb-2 font-display text-h3 text-arctic">3. Productos y precios</h2>
            <p>
          ...
          <div>
            <h2 className="mb-2 font-display text-h3 text-arctic">4. Pedidos y formas de pago</h2>
            <p>
          ...
          <div>
            <h2 className="mb-2 font-display text-h3 text-arctic">5. Envíos</h2>
            <p>
          ...
          <div>
            <h2 className="mb-2 font-display text-h3 text-arctic">6. Servicios (presupuestos)</h2>
            <p>
          ...
          <div>
            <h2 className="mb-2 font-display text-h3 text-arctic">7. Propiedad intelectual</h2>
            <p>
          ...
          <div>
            <h2 className="mb-2 font-display text-h3 text-arctic">8. Modificaciones</h2>
            <p>
          ...
          <div>
            <h2 className="mb-2 font-display text-h3 text-arctic">9. Contacto</h2>
            <p>
